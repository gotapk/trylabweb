    ...
    const i18n = {
        ...
        translations: {
            'ES': {
                ...
                'lab-s1-p1': 'En un mercado saturado de redundancias y soluciones predecibles, lo "seguro" se ha convertido en el mayor riesgo operativo. En <strong>Try Lab</strong>, entendemos la innovación no como un evento fortuito, sino como una <span class="redacted">disciplina de ruptura programada</span>. No operamos bajo la lógica de la adaptación, sino bajo la <span class="redacted">arquitectura del cambio</span>.',
                'lab-s1-p2': 'Nacimos para cuestionar el statu quo no por rebeldía, sino por una <span class="redacted">necesidad intelectual de eficiencia</span>. Donde otros ven un concepto terminado, nosotros vemos una estructura que espera ser deconstruida para alcanzar su máximo potencial.',
            ...
            'EN': {
                ...
                'lab-s1-p1': 'In a market saturated with redundancies and predictable solutions, "safe" has become the greatest operational risk. At <strong>Try Lab</strong>, we understand innovation not as a random event, but as a <span class="redacted">discipline of programmed rupture</span>. We do not operate under the logic of adaptation, but under the <span class="redacted">architecture of change</span>.',
                'lab-s1-p2': 'We were born to challenge the status quo not out of rebellion, but out of an <span class="redacted">intellectual need for efficiency</span>. Where others see a finished concept, we see a structure waiting to be deconstructed to reach its maximum potential.',
